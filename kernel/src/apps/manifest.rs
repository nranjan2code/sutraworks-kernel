...
pub struct Trigger {
    ...
    pub intent_override: Option<ConceptID>,
}
...
impl AppManifest {
    pub fn parse(source: &str) -> Result<AppManifest, ParseError> {
        ...
        // Very simple line-based parser for our subset of YAML
            ...
            if indent == 0 {
                ...
                if trim.starts_with("- ") {
                    ...
                    match current_section {
                        "triggers" => triggers.push(Trigger { input_pattern: String::new(), intent_override: None }),
